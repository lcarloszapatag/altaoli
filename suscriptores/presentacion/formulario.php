...
<tr><td><input type="text" name="p_nombre" size="25" value="<?php echo $p_nombre; ?>"></td><td> <input type="text" name="s_nombre" size="25" value="<?php echo $s_nombre; ?>"> </td></tr>
<tr><td>Primer Apellido:</td><td>Segundo Apellido:</td></tr>
<tr><td><input type="text" name="p_apellido" size="25" value="<?php echo $p_apellido; ?>"></td><td><input type="text" name="s_apellido" size="25" value="<?php echo $s_apellido; ?>"></td></tr>
...
<input type="text" name="documento_numero" id="documento_numero"  value="<?php echo $documento_numero; ?>">

<input type="text" name="documento_numero2" id="documento_numero2" value="<?php echo $documento_numero; ?>">
<div id="documca"> </div>

<tr><td>E-mail:</td><td>Rectificar E-mail: </td></tr>
<tr ><td><input type="text" name="email" id="email"  size="25" value="<?php echo $email; ?>"></td><td> <input type="text"  name="email_2" id="email_2" size="25" value="<?php echo $email; ?>"></td></tr>
...
<!-- <tr><td align="right">Pa&iacute;s:</td><td><input type="text"  name="pais" size="20" value="<?php echo $pais; ?>"></td></tr>
<tr><td align="right">Departamento/Estado:</td><td> <input type="text" name="departamento"  value="<?php echo $departamento; ?>"></td></tr>
<tr><td align="right">Municipio:</td><td> <input type="text" name="ciudad"  value="<?php echo $ciudad; ?>"></td></tr> -->
<tr><td align="right">Direccion:</td><td> <input type="text" name="direccion"  value="<?php echo $direccion; ?>" size="40"></td></tr>
<tr><td align="right"> Tel&eacute;fono fijo 1:</td><td> <input type="text" name="telefono_fijo" id="telefono_fijo"  onKeyPress="return acceptNum(event)" value=" <?php echo $telefono_fijo; ?>"><div id="tele1ca"> </div></td></tr>
<tr><td align="right"> Tel&eacute;fono movil:</td><td> <input type="text" name="telefono_celular" onKeyPress="return acceptNum(event)" value="<?php echo $telefono_celular; ?>"></td></tr>
<tr><td align="right">Nombre responsable:</td><td> <input type="text" name="nombre_responsable"  value="<?php echo $responsable_nombre; ?>"></td></tr>
<tr><td align="right">Direcci&oacute;n responsable:</td><td> <input type="text" name="direccion_responsable"  value="<?php echo $responsable_direccion; ?>"></td></tr>
<tr><td align="right">Telefono responsable:</td><td> <input type="text" name="telefono_responsable"  value="<?php echo $responsable_telefono; ?>"></td></tr>
...
<tr><td align="right"> Titulo profesional:</td><td> <input type="text" name="titulo_profesional" size="25"  value="<?php echo $titulo_profesional; ?>"></td></tr>
<tr><td align="right"> Ocupaci&oacute;n:</td><td> <input type="text" name="ocupacion" size="25"  value="<?php echo $ocupacion; ?>"></td></tr>
<tr><td align="right"> Empresa:</td><td> <input type="text" name="empresa"  value="<?php echo $empresa; ?>"></td></tr>
<tr><td align="right"> Cargo:</td><td> <input type="text" name="cargo"  value="<?php echo $cargo; ?>"></td></tr>
<tr><td align="right"> Tel&eacute;fono fijo 2:</td><td> <input type="text" onKeyPress="return acceptNum(event)" name="telefono_fijo_1"  value="<?php echo $telefono_fijo_1; ?>"></td></tr>
<tr><td align="right"> Fax:</td><td> <input type="text" name="fax"  onKeyPress="return acceptNum(event)" value="<?php echo $fax; ?>"></td></tr>
<tr><td align="right"> Tel&eacute;fono VoIP:</td><td> <input type="text" name="telefono_VoIP"  value="<?php echo $telefono_VoIP; ?>"></td></tr>
<tr><td align="right">Web: http://</td><td> <input type="text" name="web" size="25" value="<?php echo $web; ?>"></td></tr>


</table>
 <center>Observaciones:<br><textarea name="presentacion" rows="5" cols="75"><?php echo $presentacion; ?></textarea>
<hr>
