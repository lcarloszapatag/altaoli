...
<fieldset>
	...
	<tr><td>Asunto:</td><td><input type='text' name='asunto_correo' id='asunto' size="60" maxlength="255" value="<?php echo $encabezado ?><?php echo $referencia ?><?php echo $asunto ?>"></td></tr>
	<tr><td>Cuerpo:</td><td><textarea name="cuerpo_correo" cols="80" rows="15" id="cuerpo"><?php echo $descripcion ?> <?php echo $referencia ?><?php echo $mensaje ?>
